                            ...
                            <div class="lop">
                                <table>
                                    <tr>
                                        ...
                                        <td class=""><a href="repair_room.php?sttp=<?php echo $row['sttp'];?>"><button onclick="" class="repair">Sửa</button></a>
                                        <button onclick='deleteroom(this,"<?= $row["sttp"] ?>")' class='delete'>Xoá</button></td>
                                    </tr> 
                                </table>
                            </div>
                            <?php }
