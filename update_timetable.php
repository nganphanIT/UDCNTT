                    ...
                    <div class="group-box">
                        ...
                        <div class="container">
                            <form action="" method="POST">
                                <a href="./add_new.php"><input type="submit" class="icon" value="+ TẠO MỚI" ></a>
                            ...
                            <div class="lop">
                                <table>
                                    <tr>
                                        ...
                                        <td class="a"><a onclick="confirm('Bạn có muốn xóa không?')" href="functions/deletetable.php?id_thu=<?=$row["id_thu"]?>&id_buoi=<?=$row["id_buoi"]?>&sttlop=<?=$row["sttlop"]?>"><button onclick="" class="repair">Xoá</button></a></td>
                                    </tr> 
                                </table>
                            </div>
                        ...
                        <br>
                         <div>        
                            <button><a href="./functions/export_excel_timetable.php">Xuất file excel</a></button>
                        </div>
                        </div>
