            ...
            <div id="contentWrapper">
                <div id="mainContent">
                    <div class="group-box">
                        ...
                        <div class="container">
                            <form action="./functions/smspost.php" method = "POST">
                                <div class="user-details">
                                    <div class="input-box">
                                        <span class="details">TIÊU ĐỀ</span>
                                        <input type="text" name="title" placeholder="Nhap tieu de...." required>
                                    </div>
                                    
                                    <div class="input-box">
                                        <span class="details">THÔNG BÁO</span>
                                        <input type="text" name="content" placeholder="Nhap thong bao hoac tai file..." >
                                    </div>
                                </div>
                                <div class="button">
                    ...
                    <div class="group-box">
                        ...
                        <div class="leftMenu">
                            <ul>
                                ...
                                <li> <a href="hocphi.php">THỐNG KÊ</a>
                                    <ul>
                                        <li><a href="">THỐNG KÊ LỚP HỌC</a></li>
                                        <li><a href="">THỐNG KÊ HỌC PHÍ</a></li>
                                    </ul>
                                </li>
