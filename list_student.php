        ...
        <div id="contentWrapper">
            <div id="mainContent">
                <div class="group-box">
                    ...
                    <span></span>
                    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Tìm kiếm số thứ tự học viên ...">
                    <BR>
                    <div class="thongtin">
                        <table>
                            <tr>
                                ...
                                <div class="thongtin">
                                    <table>
                                        <tr class="<?= $row['tttt'] ?>">
                                            ...
                                            <td class="min"><a href="repair_list_student.php?stthv=<?php echo $row['stthv']?>"><button onclick="" class="repair">Sửa</button></a>
                                                <button onclick='delete_student(this,<?= $row["stthv"] ?>)' class='delete'>Xoá</button></td>
                                        </tr>
                                    </table>
                                </div>
                            <?php
    ...
    <script>
        function myFunction() {
            ...
            for (i = 0; i < tr.length-1; i++) {
                td = tr[i+1].getElementsByTagName("td")[1];
                if (td) {
