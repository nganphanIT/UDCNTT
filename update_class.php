            ...
            <div id="contentWrapper">
                <div id="mainContent">
                    <div class="group-box">
                            ...
                            <div class="lop">
                                <table>
                                    <tr>
                                        ...
                                        <td class=""><a href="repair_class.php?sttlop=<?php echo $row['sttlop'];?>"><button onclick="" class="repair">Sửa</button></a>
                                        <button onclick='deleteclass(this,<?= $row["sttlop"] ?>)' class='delete'>Xoá</button></td>
                                    </tr> 
                                </table>
                            </div>
                            <?php }
                        ...
                        <br>
                        <div>        
                            <button class="export"><a href="./functions/export_excel_listclass.php">Xuất file excel</a></button>
                        </div>
                        </div>
