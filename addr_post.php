                        ...
                        <div class="container">
                            <form action="./functions/addpost.php" method = "POST">
                                <div class="user-details">
                                    <div class="input-box">
                                        <span class="details">TIÊU ĐỀ ĐỊA CHỈ HOẶC LIÊN HỆ</span>
                                        <input type="text" name="title" placeholder="Nhap tieu de...." required>
                                    </div>
                                    <div class="input-box">
                                        <span class="details">NỘI DUNG ĐỊA CHỈ HOẶC LIÊN HỆ</span>
                                        <input type="text" name="content" placeholder="Nhap thong bao..." required>
                                    </div>
                                </div>
                                <div class="button">
                    ...
                    <div class="group-box">
                        ...
                        <div class="leftMenu">
                            <ul>
                                ...
                                <li> <a href="update_timetable.php">THỜI KHÓA BIỂU</a></li>
