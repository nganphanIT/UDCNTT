    ...
    if ($tenhv == "" || $mssv == "" || $sdt == "") {
        ...
        if (mysqli_num_rows($kt)  > 0) {
            ...
            if ((int)$tong_hoc_vien >= (int)$si_so) {
                ...
                $sql = "INSERT INTO hocvien(tenhv,mssv,ngaysinh,noisinh,phai,diachi,sdt,email,tttt,sttlop) VALUES ('$tenhv','$mssv','$ngaysinh','$noisinh','$phai','$diachi','$sdt','$email','$tttt','$sttlop')";
