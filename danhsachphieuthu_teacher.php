            ...
            <div id="mainContent">
                <div class="group-box">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        $stthv=$row['stthv'];
                        $sql1 = "SELECT * FROM hocvien where stthv=$stthv";
                            ...
                            <div class="thongtin">
                                <table>
                                    <tr class="<?= $row['tttt'] ?>">
                                        ...
                                        <!-- <td>
                                            <label class="<?= $row['tttt'] ?>" data-mssv="<?= $row['mssv']?>"></label>
                                            <?php
                                            ?>
                                        </td> -->
                                        <!-- <td class="min1"><button onclick='delete_student(this,<?= $row["stthv"] ?>)' class='delete'>Xóa</button></td> -->
                    ...
                    <!-- <form method="POST">
                        <button name="btn_export"><a href="./report_dspt.php">Xuất danh sách </a> </button>
                    </form> -->
                </div>
            </div>
        </div>
