...
<html>
    ...
    <body>
        ...
        <a href="./functions/export_excel_lop.php?sttlop=<?php echo $sttlop ?>"><i class="material-icons" style="font-size:24px; color:black">get_app</i></a>
       ...
       <?php
                    ...
                    $sql = "SELECT * FROM hocvien where `sttlop` = $sttlop";
